...
enum L10n {
    ...
    static func string(_ key: Key, language: AppLanguage = Preferences.appLanguage) -> String {
        ...
        case (.english, .projectURL): return "Project URL: https://github.com/wudongchen/MouseToucher"
        ...
        case (.simplifiedChinese, .projectURL): return "项目地址：https://github.com/wudongchen/MouseToucher"
